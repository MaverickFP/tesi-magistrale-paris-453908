...
/**
 * Servlet implementation class RecuperaPersonaServlet
 */
@WebServlet("/RecuperaPersonaServlet")
public class RecuperaPersonaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( resp.getStatus() == 200){
			...
			response.sendRedirect("personaView.jsp");
